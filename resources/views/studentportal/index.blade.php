...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center mb-3" style="border: 1px solid #cccccc">
                <span class="bg-success p-3 text-white" style="font-size: 18px">Notice:</span>
                <marquee style="font-size: 20px" behavior="scroll" id="notice" direction="rtl" onMouseOver="this.stop()"
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card tale-bg">
                <div class="card-people mt-auto">
                    <img src="{{ asset('backend/student') }}/images/dashboard/people.svg" alt="people">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                        <li>
                            <div class="d-flex">
                                <img src="{{ asset('backend/student') }}/images/faces/face1.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{ asset('backend/student') }}/images/faces/face2.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{ asset('backend/student') }}/images/faces/face3.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{ asset('backend/student') }}/images/faces/face4.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{ asset('backend/student') }}/images/faces/face5.jpg" alt="user">
                                <div>
