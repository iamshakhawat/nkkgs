...
<![endif]-->
    ...
    <link rel="stylesheet" href="{{ asset('frontend') }}/css/linearicons-free.css">

    <link rel="stylesheet" href="{{ asset('frontend') }}/css/animate.css">

    <link rel="stylesheet" href="{{ asset('frontend') }}/vendor/flexslider/flexslider.css">

    <link rel="stylesheet" href="{{ asset('frontend') }}/vendor/owlcarousel/owl.carousel.css">

    <link rel="stylesheet" href="{{ asset('frontend') }}/vendor/fancybox/{{ asset('frontend') }}/css/fancybox.css">

    <link rel="stylesheet" href="{{ asset('frontend') }}/css/global.css">
    <link rel="stylesheet" href="{{ asset('frontend') }}/css/style.css">
    <link rel="stylesheet" href="{{ asset('frontend') }}/css/kindergarten.css">
</head>
...
<body>
    <div class="header_meta header_meta_one">
        <div class="container">
            <div class="row">
                <ul class="social">
                    <li><a href="home-1.html#"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="home-1.html#"><i class="fa fa-facebook-square"></i></a></li>
                    <li><a href="home-1.html#"><i class="fa fa-linkedin-square"></i></a></li>
                    <li><a href="home-1.html#"><i class="fa fa-pinterest"></i></a></li>
                    <li><a href="home-1.html#"><i class="fa fa-instagram"></i></a></li>
                    <li><a href="home-1.html#"><i class="fa fa-youtube"></i></a></li>
                </ul>
    ...
    <header class="site-header home-one" id="masthead">
        <div class="container">
            <div class="row">
                ...
                <div class="site-branding col-xs-12 col-sm-3"> <a href="home-1.html#"><img alt="educationpress"
                            class="brand" src="{{ asset('frontend') }}/images/logo5.png" /></a> </div>
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown active">
                                <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                                    aria-expanded="false" href="home-1.html#">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false" href="home-1.html#">
                            ...
                            <li class="pull-right"><a title="View your cart" href="shopping-cart.html"
                                    class="menu-cart"><i class="lnr lnr-cart"></i> <span>0</span></a></li>
                        </ul>
                    </div>
                </nav>
    ...
    <div id="flex" class="flexslider kindergarten">
        <ul class="slides">
            ...
            <li style="background:url({{ asset('frontend') }}/images/use_img/banner1.jpg) no-repeat center; background-size:cover;">
                <div class="container">
                    <div class="row">
                        <div class="slide-caption">
                            <h2 data-animation="animated bounceInLeft"> An Innovative Graduate university of Theology
                            </h2>
                            <a href="home-1.html#" data-animation="animated zoomInUp"
                ...
                <div class="col-xs-12 aboutus">
                    <div class="row">
                        <div class="col-xs-12 col-sm-7">
                            ...
                            <p>Starting with the new school year in our kindergarten will discover a professional team
                                that aims to respect your child's feelings, to give them responsibility, independence
                                and freedom to make choices.</p>
                            <p>Kindergarten will discover a professional team that aims to respect your child's feeling,
                                to give them responsibility, independence and freedom to make choices.</p>
                            <a href="home-1.html#" class="btn btn-medium btn-blue">Know More <i
                        ...
                        <div class="col-xs-12 col-sm-5">
                            ...
                            <div class="flexslider about-slide">
                                <ul class="slides">
                                    <li><a href="home-1.html#"><img src="{{ asset('frontend') }}/images/use_img/about-g1.jpg"
                                                alt=""></a></li>
                                    <li><a href="home-1.html#"><img src="{{ asset('frontend') }}/images/use_img/about-g2.jpg"
                                                alt=""></a></li>
                                </ul>
                            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="text-center col-xs-12">
                        <a href="home-1.html#" data-animation="animated zoomInUp"
                            class="btn btn-medium btn-default">Know More <i class="lnr lnr-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div id="owl-classes" class="owl-carousel">
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img1.png" alt="" />
                                    </figure>
                                </a>
                        ...
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img2.png" alt="" />
                                    </figure>
                                </a>
                                <div class="classes-info">
                        ...
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img3.png" alt="" />
                                    </figure>
                                </a>
                                <div class="classes-info">
                        ...
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img4.png" alt="" />
                                    </figure>
                                </a>
                                <div class="classes-info">
                                    <div class="price">$55 <small></small></div>
                        ...
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img5.png" alt="" />
                                    </figure>
                                </a>
                                <div class="classes-info">
                                    <div class="price">$45 <small></small></div>
                        ...
                        <div class="col-xs-12 zoom">
                            <div class="classes">
                                <a href="home-1.html#" class="img-thumb">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/images/use_img/course_img6.png" alt="" />
                                    </figure>
                                </a>
                                <div class="classes-info">
                                    <div class="price">$35 <small></small></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 zoom">
                    <div class="events">
                        <a href="home-1.html#" class="img-thumb">
                            <figure>
                                <img src="{{ asset('frontend') }}/images/use_img/event1.jpg" alt="" />
                            </figure>
                        </a>
                        <div class="events-info">
                            ...
                            <a href="home-1.html#" class="know-more">Know More <i
                                    class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 zoom">
                    <div class="events">
                        <a href="home-1.html#" class="img-thumb">
                            <figure>
                                <img src="{{ asset('frontend') }}/images/use_img/event2.jpg" alt="" />
                            </figure>
                        </a>
                        <div class="events-info">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="blogs">
                        <a href="home-1.html#">
                            <figure><img src="{{ asset('frontend') }}/images/use_img/blog-thumb.jpg" alt="" /></figure>
                        </a>
                        <div class="col-sm-6">
                            <h3><a href="home-1.html#">Blog Title Will Be Here Long Secound Line Too!</a></h3>
                            <p class="meta"><span class="date">Aug 25, 2015</span> <span>.</span> By <a
                                    href="home-1.html#">Mark Freeman</a></p>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <a href="home-1.html#" class="know-more">Know More <i
                                    class="lnr lnr-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="teachers">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a href="home-1.html#" class="btn btn-medium btn-default">Know More <i
                                        class="lnr lnr-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="home-1.html#" class="btn btn-medium btn-default pull-right">Know More <i
                            class="lnr lnr-arrow-right"></i></a>
                </div>
            </div>
        </div>
    ...
    <footer class="site-footer" id="colophon">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4"><img src="{{ asset('frontend') }}/images/logo5.png" alt="" /></div>
            </div>
            <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="copyright">
                        ...
                        <p class="develop col-xs-12 col-sm-4 text-right"><a target="_blank"
    ...
    <div id="login-form" style="display:none;">
        <div class="row">
            ...
            <form id="login" action="home-1.html#">
    ...
    <div id="register-form" style="display:none;">
        <div class="row">
            ...
            <form id="register" action="home-1.html#">
    ...
    <script type="text/javascript" src="{{ asset('frontend') }}/vendor/fancybox/{{ asset('frontend') }}/js/jquery.fancybox.js"></script>
    <script type="text/javascript" src="{{ asset('frontend') }}/vendor/fancybox/{{ asset('frontend') }}/js/custom.fancybox.js"></script>
    <script>
        jQuery.noConflict();
