...
<div class="header">
    ...
    <ul class="nav float-left">
        ...
        <li>
            <a href="{{ route('admin.dashboard') }}" class="mobile-logo d-md-block d-lg-none d-block"><img
                    src="{{ asset('backend') }}/assets/img/logo1.png" alt="" width="30" height="30" height="30"></a>
        </li>
    </ul>
    ...
    <ul class="nav user-menu float-right">
        <li class="nav-item dropdown d-none d-sm-block">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <img src="{{ asset('backend') }}/assets/img/sidebar/icon-22.png" alt="">
            </a>
        ...
        <li class="nav-item dropdown d-none d-sm-block">
            <a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><img
                    src="{{ asset('backend') }}/assets/img/sidebar/icon-23.png" alt=""> </a>
        </li>
        <li class="nav-item dropdown has-arrow">
            <a href="#" class=" nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    @if (Auth::user()->photo != '')
                        <img class="rounded-circle" src="{{ asset('upload') }}/users/{{ Auth::user()->photo }}"
                            width="30" height="30" alt="{{ Auth::user()->fname }}">
                    @else
                        <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user.jpg" width="30" height="30"
                            alt="{{ Auth::user()->fname }}">
                    @endif
