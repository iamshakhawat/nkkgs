    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-content">
                <form action="{{ route('admin.editPost.student') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="row p-3">
                            <div class="col-md-12">
                    ...
                    <div class="row justify-content-center mb-3">
                        <button type="submit" class="btn btn-success mr-2">Save Student Data</button>
                        <a href="{{ route('admin.all.student') }}" class="btn btn-warning">Back</a>
                    </div>
                </form>
            </div>
        </div>
