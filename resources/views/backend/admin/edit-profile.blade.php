                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($user->photo != "")
                                                    <img src="{{ asset('upload') }}/users/{{ $user->photo }}"  height="150" alt="{{ $user->fname }}">
                                                
                                                @else
                                                    <img src="{{ asset('backend') }}/assets/img/user.jpg" height="150" alt="{{ $user->fname }}">
                                                @endif
                                            </div>  
										...
										<div class="col-md-12">
											...
											<button class="btn btn-secondary" type="button" onclick="window.location.href='{{ route('admin.profile') }}'">Cancel</button>
										</div>
                                </form>
                            </div>
                        </div>
